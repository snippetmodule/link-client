...
export type Action =
  ...
  | { type: 'LOADED_SURVEYS', list: Array<ParseObject> }
  ...
  | { type: 'RECEIVED_PUSH_NOTIFICATION', notification: ParseObject }
  | { type: 'SEEN_ALL_NOTIFICATIONS' }
  | { type: 'RESET_NUXES' }
  ;
export type DispatchAction = Action | ThunkAction | PromiseAction | Array<Action>;
export type Dispatch = (action: DispatchAction) => any;
export type GetState = () => ParseObject;
